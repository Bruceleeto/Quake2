...
{
	vec3_t default_mins = {-4096, -4096, -4096};
	vec3_t default_maxs = {4096, 4096, 4096};
	
	memset (sv_areanodes, 0, sizeof(sv_areanodes));
	sv_numareanodes = 0;
	
	// Handle case where there's no world model (cinematics, etc)
	if (sv.models[1] && sv.models[1]->mins && sv.models[1]->maxs) {
		SV_CreateAreaNode (0, sv.models[1]->mins, sv.models[1]->maxs);
	} else {
		// Use default bounds for empty world
		SV_CreateAreaNode (0, default_mins, default_maxs);
	}
}
