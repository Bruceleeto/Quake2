...
void CL_RequestNextDownload (void)
{
    ...
    // Single player - skip all the download bullshit
    ...
    if (precache_check == ENV_CNT) {
        ...
        // Skip checksum validation for SP
        /*
    ...
    // Skip texture checking for SP - we have them locally
...
void CL_Init (void)
{
	...
	Con_Init ();	
#if defined __linux__ || defined __sgi   // Why look at this later.
	S_Init ();	
	VID_Init ();
#else
	VID_Init ();
